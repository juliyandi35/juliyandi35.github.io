 ...
 * still fills the screen behind them.
 *
...
export default function AppNav() {
  ...
  return (
    <nav
      ...
      className="pointer-events-auto absolute left-3 top-20 bottom-24 w-[13.5rem] overflow-y-auto sm:left-6 sm:top-24 sm:bottom-28 sm:w-[15rem]"
    >
      <p className="font-mono-label mb-2 px-1 text-[10px] text-graphite">
